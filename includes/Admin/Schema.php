    ...
    return array(
        ...
        'validation' => array(
            ...
            'fields' => array(
                ...
                array('phone_regex','text',__('Phone regex (PHP /.../ pattern)','wc-anti-fraud-pro-lite'),'',
                ...
                array('postal_regex','text',__('Postal/ZIP regex (PHP /.../ pattern)','wc-anti-fraud-pro-lite'),'',
                      __('Optional custom addition. Leave blank to use only the preset.','wc-anti-fraud-pro-lite')),
                ...
                array('reject_address_keywords','textarea',__('Keywords list','wc-anti-fraud-pro-lite'),$D['reject_address_keywords'],
        ...
        'bot' => array(
            ...
            'fields' => array(
                ...
                array('min_render_seconds','number',__('Min seconds between render & submit','wc-anti-fraud-pro-lite'),2,__('2–3s recommended.','wc-anti-fraud-pro-lite')),
                ...
                array('device_min_age','number',__('Device min age (seconds)','wc-anti-fraud-pro-lite'),15,''),
        ...
        'cart' => array(
            ...
            'fields' => array(
                ...
                array('flag_product_ids','product_multi',__('Flag product IDs','wc-anti-fraud-pro-lite'),'',
                    __('Select products that are commonly abused for tests.','wc-anti-fraud-pro-lite')),
                array('flag_match_mode','select',__('Match mode (AND/OR)','wc-anti-fraud-pro-lite'),'any',
                ...
                array('low_value_threshold','number_currency',__('Low-value threshold','wc-anti-fraud-pro-lite'),'10.00',
        ...
        'gateways' => array(
            ...
            'fields' => array(
                array('enable_gateway_friction','checkbox',__('Enable gateway friction','wc-anti-fraud-pro-lite'),0,
                ...
                array('min_total_for_card','text',__('Min order total to show card gateways','wc-anti-fraud-pro-lite'),'10.00',''),
